...
class EagleMetaForCausalLM(ABC):
    ...
    def prepare_inputs_labels_for_multimodal(
        ...
        images, image_sizes=None, modality='image', image_grid_thw=None
    ):
        ...
        # print(f"images[0]: {type(images[0])}")
        # print(f"image_grid_thw: {image_grid_thw}")
        # Add modality condition, mod by hxl
        if False and (type(images) is list or images.ndim == 5) and modality=='image':
            ...
            if getattr(self.config, 'mlp_smoe', False):
                ...
                image_features = self.encode_images(images, image_grid_thw)
